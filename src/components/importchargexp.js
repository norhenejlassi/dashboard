...
import Sidebar from './Sidebar'
 class Importchargexp extends Component {
    constructor(props) {
      super(props);
    ...
    componentDidMount(){
      ImportService.getChargexp().then((res) => {
    ...
    uploadchargexp() {
      ...
      ImportService.uploadchargexp(currentFile, (event) => {
...
export default withRouter(Importchargexp);